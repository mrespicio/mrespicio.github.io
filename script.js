...
const allFolder = [];
allFolder.push(ticTacToe, library, adminDashboard, tonicSignUpForm, 
    pokedex, calculator, etchASketch, rps, earthAlly, odinRecipes);

const featuredFolder = [];
featuredFolder.push(ticTacToe, tonicSignUpForm, etchASketch, 
    earthAlly);

const recentFolder = [];
recentFolder.push(ticTacToe, library, adminDashboard, tonicSignUpForm);
